    ...
    >
      {tiles.map((t) => (
        ...
        >
          ...
          />
          {t.live > 0 && (
            <span className="absolute left-2.5 top-2.5 inline-flex items-center gap-1 rounded-full bg-black/55 px-2 py-0.5 text-nano font-bold text-white">
          ...
          <span className="relative text-micro font-semibold text-white/75 tabular-nums sm:text-xs">
